...
// browser-route-module:routes/cadastro_reme.tsx?browser
init_global();
init_dirname();
init_filename();
init_buffer();
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "sm:mx-auto sm:w-full sm:max-w-sm", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h2", { className: "mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900", children: "Cadastro Rem\xE9dio" }, void 0, false, {
          fileName: "app/routes/cadastro_reme.tsx",
          lineNumber: 41,
          columnNumber: 13
        }, this)
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-10 sm:mx-auto sm:w-full sm:max-w-sm", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("form", { className: "space-y-6", action: "#", method: "get", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("label", { htmlFor: "email", className: "block text-sm font-medium leading-6 text-gray-900", children: "Pre\xE7o" }, void 0, false, {
          fileName: "app/routes/cadastro_reme.tsx",
          lineNumber: 58,
          columnNumber: 15
        }, this),
...
//# sourceMappingURL=/build/routes/cadastro_reme-6OPNONJ6.js.map
